    ...
    <div class="category">
      <div class="product">
        <div v-if="!product" class="card" style="width: 16rem;">
          <img
            src="https://assets.swappie.com/iPhone-6-Plus-space-gray-back.png"
            class="card-img-top"
          />
          <div class="card-body">
            ...
            <p
              class="card-text"
            >Apple iPhone 6 Plus ; CPU, Dual-core 1.4 GHz Typhoon (ARM v8-based) ; GPU, PowerVR GX6450 (quad-core graphics) ; Memory, Card slot ; Internal, 16GB 1GB RAM</p>
...
export default {
  ...
  methods: {
    getProduct(SubID) {
      axios
        .get(`http://localhost:3001/api/product/${SubID}`)
